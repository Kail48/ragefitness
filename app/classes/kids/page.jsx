...
import hero2Image from "../../../public/images/kidsHero3Image.png";
import fitnessHero1Image from "../../../public/images/kidsHero2Image.png";
import kidsMMAImage from "../../../public/images/strikeMmaImage.png";
import kidsStrikingImage from "../../../public/images/strikeBoxingImage.png";
import kidsBjjImage from "../../../public/images/fitnessStrengthImage.png";
    ...
    <div className="w-screen">
      ...
      <div className=" bg-black font-header text-header3 md:text-header text-lightyellow text-center py-12 overflow-x-hidden">
        <div className="w-full md:flex px-10 mt-12 mb-8 md:mb-16  items-center md:mt-12 bg-black text-white">
          <div className="md:px-4">
            <div className="font-header text-[36px] md:text-[80px] md:leading-snug text-start">
              <span className="text-white">KIDS MMA</span>
              <br />
              <span className="text-red">& JIU JITSU</span>
            </div>
        ...
        <Hero
          ...
          secondaryHeader={[`SIGN UP NOW FOR THE BEST`, `KIDS MMA CLASSSES IN`,`TEMECULA CA`]}
        ...
        <Hero
          ...
          button1Text="GET 1 WEEK TRIAL PASS"
          secondaryHeader={[
            "EQUIP YOUR CHILDREN WITH ",
            "PROPER SELF-DEFENSE SKILLS",
            "WITH OUR TEMECULA KIDS",
            "MMA CLASSES"
          ]}
        ...
        <TrainerSection
          ...
          header2={`KIDS MMA COACHES`}
          slides={slides}
        />
        <Testimonial
          testimonialData={testimonialData}
          headerWhite={`REVIEWS FROM OUR `}
          headerLight={`KIDS MMA PARENTS`}
        />
