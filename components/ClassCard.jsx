...
export default function ClassCard({ img, text, link,isThreeCols }) {
  return (
    <div className="">
      <Link href={link}>
        <div className={`relative  ${isThreeCols?"h-[500px]":"h-[374px]"}  ${isThreeCols?"w-[382px]":"w-[286px]"}`}>
          ...
          <div className={`absolute bottom-16 left-0 right-0 text-center text-white flex justify-center items-center font-header md:text-header3 py-2`}>
            <div className="bg-red py-3 px-2 md:w-48 rounded-md whitespace-normal leading-6">
              <h2>{text}</h2>
            </div>
          </div>
        </div>
