    ...
    <div>
      {title?(
        ...
        <div className="text-lightyellow text-3xl md:text-7xl text-center leading-10 md:my-16">
          <span className="">HEAR WHAT OUR</span><br/>
          <span>MEMBERS </span><span className="text-white">HAVE TO SAY</span>
          </div>
      )}
      ...
      {qnaData.map((data, index) => (
        <div key={index} className="py-4 md:mx-6 md:my-4">
          <div className="flex items-center">
            ...
            <h1 className="font-header text-[20px] md:text-[40px] text-red ">
